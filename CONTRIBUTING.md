...
This repository uses [`semistandard`][semistandard-url] to maintain code style and consistency,
and to avoid style arguments. `npm test` runs `semistandard` automatically, so you don't have
to!
